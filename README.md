...
- девять обезличенных экспортов реальных n8n workflow.
...
Импортируемые безопасные экспорты находятся в [`workflows/`](workflows/README.md). Они содержат настоящие узлы, связи, Code-ноды, AI prompts и расписания, но не содержат credentials и рабочих идентификаторов.
...
├── workflows/           # очищенные экспорты n8n
├── scripts/             # повторяемая очистка экспортов
